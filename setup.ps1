...
Write-Host "    Call Track — Setup" -ForegroundColor Cyan
Write-Host "  ================================" -ForegroundColor Cyan
Write-Host ""
...
$sc.Description = "Start Call Track App"
$sc.IconLocation = "$env:SystemRoot\System32\SHELL32.dll,137"
$sc.Save()

Write-Host "  Created: 'Start Call Track' on Desktop" -ForegroundColor Green

# Create STOP shortcut on Desktop
$stopShortcut = Join-Path $desktopPath "Stop Call Track.lnk"
...
$sc2.Description = "Stop Call Track App"
$sc2.IconLocation = "$env:SystemRoot\System32\SHELL32.dll,131"
$sc2.Save()

Write-Host "  Created: 'Stop Call Track' on Desktop" -ForegroundColor Green
Write-Host ""
Write-Host "  Setup complete!" -ForegroundColor Green
Write-Host ""
Write-Host "  Two shortcuts have been added to your Desktop:" -ForegroundColor White
Write-Host "   - 'Start Call Track'  -- double-click to launch the app" -ForegroundColor White
Write-Host "   - 'Stop Call Track'   -- double-click to shut it down" -ForegroundColor White
Write-Host ""
